                        ...
                        <ul>
                            <li className="bg-blue-50 flex items-center">
                                <div className="relative w-1/4 h-20">
                                    <img src="http://fakeimg.pl/60/555555/FFA500/?text=F" alt="" className="rounded-full m-3"/>
                                    <div className="absolute top-2 left-2 flex items-center justify-center border-black border-2 rounded-full w-5 h-5">
                                        <p>1</p>
                                    </div>
